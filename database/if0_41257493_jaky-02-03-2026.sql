...
-- Tiempo de generación: 02-03-2026 a las 10:17:09
...
(42, 1, 'productos', 'crear', 'Alta de producto: Anillo acero (Código: Ddder)', '186.141.199.95', '2026-02-28 16:05:47'),
(43, 1, 'movimiento', 'movimientos', 'Movimiento: entrada - Producto ID 25 - Cantidad 10', '186.141.199.95', '2026-02-28 16:07:29');
...
(20, 25, 'entrada', '10.00', 'General', NULL, 1, 1, '2026-02-28 16:07:29');
...
(1, '2026-02-26 12:51:34', 'Dario Sergio', '3333', 'xxx@skks.com', 'kddkdk 3344', '3000.00', 'cancelado'),
(2, '2026-02-27 17:01:59', 'Gerardo Montiel', '444', 'eee@hotmail.com', 'dfsfa 444', '3200.00', 'cancelado'),
...
INSERT INTO `pedido_detalle` (`id`, `pedido_id`, `producto_id`, `descripcion`, `precio`, `cantidad`, `subtotal`) VALUES
(1, 1, 9, 'Anillo de inoxidable liso n23', '1000.00', '2.00', '2000.00'),
(2, 1, 10, 'Anillo dorado n20', '1000.00', '1.00', '1000.00'),
(3, 2, 9, 'Anillo de inoxidable liso n23', '1000.00', '1.00', '1000.00'),
(4, 2, 8, 'Aro premium dorado', '2200.00', '1.00', '2200.00'),
(5, 3, 22, 'Anillo plata n18', '1200.00', '1.00', '1200.00'),
(6, 3, 24, 'Cadena barbada fina', '1500.00', '1.00', '1500.00'),
(7, 4, 9, 'Anillo de inoxidable liso n23', '1000.00', '1.00', '1000.00'),
(8, 4, 13, 'Flor azul', '600.00', '1.00', '600.00');
...
(25, 1, 'Ddder', 'Anillo acero', NULL, 1, 10, 5, '500.00', '10000.00', 1);
...
(13, 25, 'General', '10.00', '2026-02-28 16:07:29', NULL);
